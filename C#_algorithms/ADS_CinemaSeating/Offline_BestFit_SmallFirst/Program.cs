...
namespace Offline_BestFit_SmallFirst
{
    class Program
    {
        /// <summary>
        /// places smallest groups first, at the first place where they create the least amount of new unavailable seats
        /// </summary>
        static void Main(string[] args)
        {
            ...
            // find a seating for each group, starting with the smallest groups
            for (int i = 0; i < 8; i++)
            {
